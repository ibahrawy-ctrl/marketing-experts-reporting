...
> **لماذا الوسم على `4fddc20` وليس على رأس `develop` الأحدث:** الوسم يشير إلى **الشجرة
> التي بُنِيت ونُشِرت وفُحِصت فعلًا على TEST**، لا إلى أحدث ما على الفرع. التزامان
> لاحقان (`178a525` بوّابات UAT تحت `Ops/` · `f4ea3ec` تقريرا الإغلاق) **لا يمسّان
> أيّ ملفّ منتج أو هجرة**، فلا يغيّران الأثر القابل للنشر. عند النشر يُبنى من الوسم.
