...
**لماذا لا يُذكَر رأس الفرع هنا:** ملفّ لا يستطيع أن يحتوي بصمته الخاصّة — كلّ محاولة لكتابتها تُغيّرها. لذا **«البصمة النهائيّة» في هذا التقرير تعني حصرًا مرشّح الكود `41954cc…`**، وهو ما قيست عليه أرقام §8 و§10 بالضبط. أمّا الدفعات اللاحقة على الفرع فهي **توثيقيّة خالصة** (هذا الملفّ وحده)، وبصمة رأس الفرع تُقرأ من `git rev-parse HEAD` لا من هذه الصفحة.

**الثابت الذي يجعل هذا آمنًا:** أيّ دفعة بعد `41954cc` يجب أن تكون صفر ملفّ كود. مُتحقَّق منه بـ`git diff --stat 41954cc HEAD` ⇒ ملفّ واحد فقط هو `Ops/P3-NAVIGATION-FINAL-LOCAL-RELEASE-READINESS-REPORT-20260825.md`. لذا تبقى كلّ أرقام الاختبارات صالحة على رأس الفرع بلا إعادة تشغيل.
...
candidate:
  final_sha: "41954ccff768b56e198af23b51648dbdb1da05c9"   # مرشّح الكود — كلّ الأرقام مقيسة عليه
  branch_head_sha: "READ_FROM_GIT"                        # لا يُكتَب هنا: ملفّ لا يحتوي بصمته
  post_candidate_commits: "توثيقيّة فقط — صفر ملفّ كود بعد final_sha"
  parent_sha: "7e324d2"
