...
**تمييز لازم بين بصمتين** — التقرير لا يستطيع أن يحمل بصمة نفسه، فالتصريح هنا صريح بدل أن يكون ضمنيًّا:

| البصمة | ماذا تعني |
|---|---|
| `41954ccff768b56e198af23b51648dbdb1da05c9` | **مرشّح الكود** — كلّ رقم في §8 و§10 مقيس على هذه الشجرة بالضبط، ولا سطر كود بعدها |
| `821b403569922373ba89a6e7dc42c94a21812a64` | **رأس المرحلة** — دفعة توثيقيّة خالصة تضيف هذا الملفّ وحده (`Ops/…md`, +765 سطرًا، صفر ملفّ كود) |

الفرق بينهما **توثيق فقط**، مُتحقَّق منه: `git diff --stat 41954cc 821b403` يُظهر ملفًّا واحدًا هو هذا التقرير. لذا تبقى كلّ أرقام الاختبارات صالحة على رأس المرحلة بلا إعادة تشغيل.
...
candidate:
  code_candidate_sha: "41954ccff768b56e198af23b51648dbdb1da05c9"
  final_sha: "821b403569922373ba89a6e7dc42c94a21812a64"
  final_sha_delta_from_code_candidate: "هذا التقرير فقط — ملفّ واحد، صفر ملفّ كود"
  parent_sha: "7e324d2"
