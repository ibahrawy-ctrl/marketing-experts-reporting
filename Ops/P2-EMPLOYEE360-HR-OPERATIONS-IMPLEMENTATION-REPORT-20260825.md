...
| P2-ATT-004 | نواة Workflow للحضور | قيد التنفيذ |
| P2-ATT-005 | دومين الحضور + هجرة إضافيّة | قيد التنفيذ |
| P2-ATT-006 | آلة الحالات وواجهات API للحضور | قيد التنفيذ |
| P2-ATT-007 | واجهات الحضور | قيد التنفيذ |
| P2-HR-008 | محرّك الالتزامات المتوقَّعة | قيد التنفيذ |
| P2-HR-009 | لوحة HR Operations وطوابير الإجراءات | قيد التنفيذ |
| P2-HR-010 | قائمة خدمة الموظّف والالتزام | قيد التنفيذ |
