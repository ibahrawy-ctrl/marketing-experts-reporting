...
> ⚠︎ **هذا القسم مؤرَّخ بلحظة التدقيق وحدها، وقد جبّته التصحيحات (ت-1) و(ت-2) أعلاه.**
> الرقم الصحيح `844/844`، والمرجعان `backup/unexpected-r22b-commit-*` **أُنشئا بأمر صريح** بعد هذا
> القياس وهما قائمان محلّيًّا. ما يلي يُقرأ سجلًّا لحالة اللحظة لا حكمًا ساريًا.
