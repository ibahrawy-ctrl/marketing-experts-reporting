...
/// الكتابة مسموحة لأدوار إدارة الخطّة (ProjectPlanManagers) أو لمدير حسابات المشروع نفسه، لا بالدور وحده،
/// لذا لا تُوضع سياسة ManagementOnly على الكتابة (كانت تحجب مدير الحسابات وتشمل قائد الفريق).
