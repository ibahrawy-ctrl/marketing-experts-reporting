...
public sealed class KpiFeatureOptions
{
    ...
    /// <summary>
    /// DEC-01/13 — الحدّ الأدنى لاعتماد **الرقم المجمَّع لأيّ نافذة قراءة** (أسبوع/شهر/ربع/سنة) = **80%**
    /// من <c>AdjustedExpected</c> (كان 0.75 قبل اعتماد العقد). دونه: الدرجة «مؤقّتة» والحالة
    /// <c>InsufficientCoverage</c>، ولا تدخل المتوسّط الرسميّ ولا التصدير المالي النهائي (DEC-01/14).
    ///
    /// R6/§5.7 — لا علاقة لهذا النطاق بالاكتمال: <see cref="KpiCompletenessState"/> يُحسَب بلا هذه العتبة
    /// إطلاقًا. ووصف «النتيجة الربعيّة» السابق كان من مفردات المسار الربعيّ الملغى، والمقصود دائمًا
    /// تجميع حقائق **النبض الأسبوعيّ المعتمَد** ضمن النافذة المطلوبة.
    /// </summary>
