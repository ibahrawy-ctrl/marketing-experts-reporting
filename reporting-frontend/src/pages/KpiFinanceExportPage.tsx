    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-ink-2">
          معاينة وتصدير تقييمات مؤشرات الأداء الأسبوعية المعتمَدة الواقعة داخل الربع المختار، على مستوى الشركة.
          كلّ صفّ = تقييم أسبوعي معتمَد واحد (لا متوسط ربع سنوي).
        </p>
      </div>

      <Alert tone="navy">
        هذا التصدير قراءة فقط ولا يقوم بحساب أو صرف أي مستحقات مالية.
      </Alert>
          ...
          {(data?.rows ?? []).length === 0 ? (
            <div className="p-5">
              <EmptyState
                ...
                description="لا توجد تقييمات أسبوعية معتمَدة داخل هذا الربع بالفلاتر المختارة. التصدير سيُنتج رؤوس الأعمدة فقط."
              />
            </div>
          ) : (
