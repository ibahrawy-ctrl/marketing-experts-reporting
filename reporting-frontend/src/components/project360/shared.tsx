 ...
 *
 * **مصدرهما الخادم لا الواجهة** (§12): تُشتقّان من `overview.access` الذي يبنيه الخادم من
 * حرّاسه نفسها. كانت الواجهة تعيد اشتقاقهما محلّيًّا من الأدوار والمعرّفات — نسخة موازية
 * تنحرف عن الأصل عند أوّل تعديل في قواعد التخويل، فتَعِد بزرٍّ يردّه الخادم أو تُخفي
 * إجراءً مسموحًا. التحويل من `ProjectCapabilitiesDto` يقع في `Project360Page` وحدها،
 * وهي المكان الوحيد الذي تُقرأ فيه الحمولة أصلًا؛ التبويبات تستقبل النتيجة خاصّيّةً.
 */
